...
from app.llm.failover import FAILURE_THRESHOLD, FailoverJudge, JudgeError, JudgeFn, ProviderDown
...
def make_judge(failure_threshold: int = FAILURE_THRESHOLD) -> FailoverJudge:
