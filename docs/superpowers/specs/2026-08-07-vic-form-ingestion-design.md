...
follows). VIC Regs 2021 Schedule 1 ("Schedule 1—Forms") holds 25 form
openers in versions 001-004 and 27 in 005-009 (Forms 1-25 plus 3A and
16A) - including Form 1 (residential rental agreement of no more than
5 years, 32 numbered terms) and Form 2 (more than 5 years, 40 terms),
the two agreements sub-project (c) will compare leases against - but
...
- A term yields `section_no="S{sch}-F{form}-T{term}"` (Schedule 1 today,
  so `S1-F1-T7` shapes; the form discriminator is forced by 27 forms
...
every cached version's Normal-styled "Form 5" opener is caught by an
exact-text fallback, itself case-insensitive. A form whose term
