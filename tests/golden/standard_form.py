...
PARAPHRASES = {
    ...
    "nsw.clause.sf_t19": (
        ...
        "tradesperson entering to carry out maintenance or repairs needed to avoid "
        "health or safety risks or to avoid the risk of gas, electricity, water, "
        "telecommunications or other services being disconnected, will "
